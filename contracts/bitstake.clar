;; Title: BitStake - Decentralized Bitcoin-Backed Staking Protocol
;;
;; Summary:
;; A Bitcoin-native staking protocol on Stacks Layer 2 that allows users to stake STX tokens,
;; participate in governance, and earn rewards with tiered benefits.
;;
;; Description:
;; BitStake enables users to stake STX tokens with flexible lock periods to earn rewards
;; while gaining voting power in the protocol's governance system. The protocol features
;; a tiered membership system that provides escalating benefits based on stake amount,
;; enhancing Bitcoin's ecosystem with DeFi capabilities while maintaining proper security
;; through cooldown periods and minimum stake requirements.
